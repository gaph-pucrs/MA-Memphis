...
class Kernel:
	...
	def generate_definitions(self):
		...
		definitions.define("PKG_PENDING_SVC_MAX", str(20))
		definitions.define("PKG_SLACK_TIME_WINDOW", str(50000))
		definitions.define("PKG_MAX_KERNEL_MSG_LEN", str(5))
		...
		definitions.write(self.testcase_path+"/include/kernel_definitions.h")
