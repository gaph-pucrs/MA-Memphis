...
from build_utils import ApplicationInfo, get_app_task_name_list, get_ma_task_name_list
	...
	for app_reader in yaml_reader["apps"]:
		...
		for static_task in static_mapping_tasks:
			if static_task not in app_task_list: 
				print "[WARNING]: Static task name ["+static_task+"] does not belong to application [management], it will be ignored in static mapping\n"
