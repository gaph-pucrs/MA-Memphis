...
int main(){
    ...
    memphis_receive(&msg, sorting_1); // AQUI
    ...
    memphis_send(&msg, sorting_9); // AQUI
    puts("Ramo direito:\n");
    for(i=0; i<halfTamanho; i++){
        msg.payload[i] = vector[aux];
        printf("%d\n", msg.payload[i]);
    ...
    msg.length = tamanho;
    memphis_send(&msg, sorting_1); // AQUI
