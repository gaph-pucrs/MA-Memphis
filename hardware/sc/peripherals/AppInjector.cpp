...
AppInjector::AppInjector(sc_module_name _name) : 
	sc_module(_name) 
{
...
{
	static std::ifstream appstart("appstart.txt");
...
{
	std::string path = "../applications/" + name + "/repository.txt";
